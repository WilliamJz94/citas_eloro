...
$con = connect();
$id = $_GET['id'];
$sql = "SELECT * FROM especialidades  WHERE codespe= '$id'";
$query  =$con->query($sql);
$data =  array();
if($query){
...
<?php if(count($data)>0):?>
    <?php foreach($data as $d):?>
          <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form method="POST"  autocomplete="off" action="../../folder/especialidad.php?id=<?php echo $d->codespe; ?>"  role="form">
             

              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Especialidad</span>
                <input name="especialidad" value="<?php echo $d->especialidad; ?>" type="text"
              ...
              <label class="block text-sm">
                ...
                <input name="descripcion" value="<?php echo $d->descripcion; ?>" type="text"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
