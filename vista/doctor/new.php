        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              ...
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="../../folder/especialidades.php"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
           ...
           <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form method="POST"  autocomplete="off" enctype="multipart/form-data"  role="form">
              ...
              <label class="block text-sm">
                ...
                <input maxlength="10" name="dnidoc" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required="" type="text"
              ...
              <label class="block mt-4 text-sm">
                ...
                <select  name="codespe" id="espe" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                  <option>Selecione especialidad</option>
              ...
              <!--<label class="block mt-4 text-sm">
                ...
                <select name="sexo" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
              ...
              <label class="block text-sm">
                ...
                <input name="telefo" maxlength="10" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required="" type="text"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
...
$sql = "select * from medico where dnidoc='$dnidoc' or correo='$correo' or telefo='$telefo' or ciudad='$ciudad' ";
...
$sql2 = "INSERT INTO medico(dnidoc,nomdoc,apedoc,codespe,sexo,telefo,ciudad,fechanaci,correo,estado)VALUES ('$dnidoc','$nomdoc','$apedoc','$codespe','$sexo','$telefo','$ciudad','$fechanaci','$correo','$estado')";
