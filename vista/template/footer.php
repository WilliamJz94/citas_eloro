...
// Realizamos la consulta para saber si coincide con uno de esos criterios
$sql = "select * from especialidades where especialidad='$especialidad' or descripcion='$descripcion'";
$result = mysqli_query($conn, $sql);
?>
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "INSERT INTO especialidades(especialidad,descripcion,estado)VALUES ('$especialidad','$descripcion','1')";
...
Swal.fire({
  ...
  timer: 2500
            ...
            window.location = "../folder/especialidad.php";
        });
        </script>
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "update especialidades set especialidad='$especialidad'where codespe='$id'";
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "update medico set dnidoc='$dnidoc', nomdoc='$nomdoc', apedoc='$apedoc', codespe='$codespe', sexo='$sexo', telefo='$telefo', ciudad='$ciudad',fechanaci='$fechanaci', correo='$correo' where coddoc='$id'";
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "INSERT INTO calendario(nomhora,coddoc,estado)VALUES ('$nomhora','$coddoc','$estado')";
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "update calendario set nomhora='$nomhora', coddoc='$coddoc' where idhora='$id'";
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "update citas set start='$start',end='$end' where codcit='$id'";
            ...
            ?>
                {
                    ...
                    especialidad: '<?php echo $event['especialidad']; ?>',
